    ...
    <main className="pb-12">
      ...
      <section className="mt-5 rounded-[20px] border border-[var(--line)] bg-white p-6 sm:p-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-lg font-bold">Original file</h2>
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-[#cad5d8] bg-[#f8fafb] px-5 py-8 text-center">
          <p className="font-semibold">Teaching viewer is the next layer</p>
          <p className="mx-auto mt-1 max-w-xl text-sm leading-6 text-[var(--muted)]">
            PDF page navigation, slide previews, image zoom and presentation-mode fullscreen will use this resource/version record.
          </p>
        </div>

        {canEdit ? (
          <div className="mt-5 border-t border-[var(--line)] pt-4 text-xs text-[var(--muted)]">
            Editor controls for rename, version replacement, approval and delete will be added to this page after the viewer.
          </div>
        ) : null}
      </section>
    </main>
