    ...
    >
      <div className="flex min-h-14 flex-wrap items-center justify-between gap-2 border-b border-white/10 bg-[#162126] px-3 py-2 text-white sm:px-4">
        <div className="min-w-0">
          ...
          {pageLabel ? <p className="text-xs text-white/60">Page {pageLabel}</p> : null}
        </div>
      ...
      <div className={`${isFullscreen ? "h-[calc(100vh-56px)]" : "h-[68vh] min-h-[520px]"} relative overflow-auto bg-[#0d1418]`}>
        {kind === "pdf" && fileUrl ? (
          <iframe
        ...
        {kind === "image" && fileUrl ? (
          <div className="flex min-h-full min-w-full items-center justify-center p-6">
            <div
              className="relative h-[80%] min-h-[420px] w-[90%] min-w-[320px] origin-center transition-transform"
        ...
        {kind === "slides" && currentPage ? (
          <div className="flex min-h-full min-w-full items-center justify-center p-6">
            <div
              className="relative aspect-[16/9] w-[92%] min-w-[480px] origin-center bg-white shadow-2xl transition-transform"
              style={{ transform: `scale(${zoom})` }}
            >
              <Image
            ...
            <div className="max-w-lg">
              ...
              <p className="mt-2 text-sm leading-6 text-white/65">
                {processingStatus === "failed"
                  ...
                  : "This PowerPoint or Word document needs the document-processing worker to generate slide/page previews."}
              </p>
            </div>
          </div>
        ) : null}
